...
export function BenefitsSection() {
  ...
  const items = t("marketing.benefits.items", {
    returnObjects: true,
  }) as Array<{
    title: string;
    description: string;
  ...
  return (
    <section
      ...
      aria-label="Voordelen van Servio voor ondernemers"
    >
        ...
        <div className="grid sm:grid-cols-2 gap-6 max-w-4xl mx-auto">
          {items.map((benefit, index) => {
            ...
            return (
              <div
                key={index}
                className="group p-8 rounded-xl bg-card hover:border-border transition-all duration-300 animate-fade-in-up"
