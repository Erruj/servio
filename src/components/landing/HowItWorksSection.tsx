...
export function HowItWorksSection() {
  ...
  const steps = t("marketing.howItWorks.steps", {
    returnObjects: true,
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10 text-center md:text-left group">
                    <div className="inline-flex items-center justify-center w-24 h-24 rounded-xl bg-muted/50 mb-6 mx-auto md:mx-0 group-hover:border-primary/30 group-hover:bg-primary/5 transition-all duration-300">
                      <Icon
