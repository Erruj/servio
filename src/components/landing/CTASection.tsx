    ...
    <section className="py-24 md:py-32">
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          <div className="relative rounded-xl bg-gradient-to-br from-primary/10 via-accent/5 to-primary/10 border border-primary/20 p-10 md:p-16 text-center overflow-hidden animate-scale-in">
            ...
            <div className="relative z-10">
              <h2
                className="text-3xl md:text-4xl lg:text-5xl font-semibold tracking-[-0.02em] text-foreground mb-6 animate-fade-in-up"
              ...
              <div
                className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 mb-10 text-sm animate-fade-in-up"
              ...
              >
                <Button
                  size="lg"
                  className="h-14 px-10 text-base font-medium rounded-xl transition-all duration-300 hover:scale-[1.02] "
