    ...
    <div className="relative w-full h-full bg-[hsl(220_14%_98%)] text-foreground overflow-hidden flex">
      ...
      <div className="flex-1 relative min-w-0">
        ...
        <div className="relative h-[calc(100%-3rem)]">
          <SceneWrap visible={scene === 0}>
            <InboxScene />
          </SceneWrap>
          <SceneWrap visible={scene === 1}>
            <ReplyScene />
          </SceneWrap>
          <SceneWrap visible={scene === 2}>
            <DashboardScene />
          </SceneWrap>
          <SceneWrap visible={scene === 3}>
            <InvoiceScene />
          </SceneWrap>
        </div>
...
const inboxItems = [
  {
    from: "Anna Bakker",
    subj: "Vraag over offerte 2026-104",
    snippet: "Hoi, kunnen we de levertijd nog bespreken?",
    time: "09:42",
    unread: true,
    label: "Klant",
  },
  {
    from: "Stripe",
    subj: "Betaling ontvangen — €1.250,00",
    snippet: "Factuur INV-0421 is voldaan door Bakker BV.",
    time: "09:21",
    label: "Financieel",
  },
  {
    from: "KPN Zakelijk",
    subj: "Factuur november beschikbaar",
    snippet: "Uw maandfactuur staat klaar in het portaal.",
    time: "08:55",
    label: "Leverancier",
  },
  {
    from: "Tom Janssen",
    subj: "Re: Project planning Q2",
    snippet: "Top, dan plannen we de kickoff voor dinsdag.",
    time: "Gister",
    label: "Intern",
  },
  {
    from: "Belastingdienst",
    subj: "Bevestiging BTW-aangifte",
    snippet: "Uw aangifte over Q3 is succesvol verwerkt.",
    time: "Gister",
    label: "Overheid",
  },
];
    ...
    <div className="h-full flex animate-fade-in">
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-baseline justify-between gap-2">
                  <span
                    className={`text-[12px] truncate ${m.unread ? "font-semibold" : "font-medium"}`}
                  >
                    {m.from}
                  </span>
                ...
                <div className="text-[12px] truncate text-foreground/90">
                  {m.subj}
                </div>
              ...
              {i === 0 && (
                <Star className="w-3 h-3 text-warning fill-warning shrink-0 mt-1" />
              )}
            </div>
          ))}
        </div>
      ...
      <div className="hidden md:flex flex-1 flex-col p-4">
        <div className="text-[13px] font-semibold mb-1">
          Vraag over offerte 2026-104
        </div>
        <div className="text-[11px] text-muted-foreground mb-3">
          Anna Bakker • anna@bakkerbv.nl
        </div>
        <div className="text-[12px] text-foreground/80 leading-relaxed space-y-2">
          <p>Hoi,</p>
          <p>
            Bedankt voor de offerte. We willen graag akkoord, maar kunnen we de
            levertijd nog bespreken? Eind januari zou ideaal zijn.
          </p>
          <p>
            Groet,
            <br />
    ...
    <div className="h-full flex animate-fade-in">
      <div className="hidden md:block w-[35%] border-r border-border/60 p-4">
        ...
        <div className="text-[11px] text-muted-foreground leading-relaxed">
          Hoi, bedankt voor de offerte. We willen graag akkoord, maar kunnen we
          de levertijd nog bespreken? Eind januari zou ideaal zijn.
        </div>
      </div>
...
function Typewriter({ text }: { text: string }) {
  ...
  return (
    <>
      {out}
      <span className="inline-block w-[2px] h-3 bg-primary/70 align-middle ml-0.5 animate-pulse" />
    </>
  );
}
        ...
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="flex gap-2 text-[10px] text-muted-foreground">
            <span className="flex items-center gap-1">
              <span className="w-2 h-2 rounded-sm bg-primary" /> 2026
            </span>
            <span className="flex items-center gap-1">
              <span className="w-2 h-2 rounded-sm bg-border" /> 2025
            </span>
          </div>
        </div>
      ...
      <div className="mt-3 rounded-lg border border-border/60 bg-card p-2.5 flex items-center gap-2">
        ...
        <div className="flex-1 min-w-0">
          <div className="text-[11px] font-medium">
            3 nieuwe betalingen ontvangen
          </div>
          <div className="text-[10px] text-muted-foreground">
            Automatisch gematcht aan facturen
          </div>
        </div>
      ...
      <div className="w-[45%] flex flex-col">
        ...
        <div className="flex-1 rounded-lg border-2 border-dashed border-primary/30 bg-primary/[0.03] flex flex-col items-center justify-center p-4 text-center">
          ...
          <div className="text-[10px] text-muted-foreground mt-1.5 flex items-center gap-1">
            <Sparkles className="w-3 h-3 text-primary" /> AI leest factuur
            uit...
          </div>
        </div>
      </div>
...
function Field({
  ...
  return (
    <div className="flex items-center justify-between py-1 border-b border-border/40 last:border-0">
      ...
      <span
        className={highlight ? "font-semibold text-primary" : "font-medium"}
      >
        {value}
      </span>
    </div>
