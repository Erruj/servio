...
export function HeroSection() {
  ...
  return (
    <section
      ...
      aria-label="Servio AI bedrijfsassistent introductie"
    >
      ...
      <div className="container mx-auto px-6 relative">
        <div className="max-w-4xl mx-auto text-center">
          <div
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-background text-sm text-muted-foreground mb-8 animate-fade-in"
