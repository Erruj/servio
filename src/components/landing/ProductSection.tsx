...
export function ProductSection() {
  ...
  const items = t("marketing.product.items", { returnObjects: true }) as Array<{
    title: string;
    description: string;
    metrics: string[];
  }>;
  ...
  return (
    <section
      ...
      aria-label="Servio producten overzicht"
    >
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {items.map((product, index) => {
            ...
            return (
              <div
                key={index}
                className="group rounded-xl overflow-hidden bg-card hover:border-border transition-all duration-500 animate-fade-in-up"
              ...
              >
                <div className="aspect-[4/3] bg-muted/30 p-5 relative overflow-hidden">
                  ...
                  <div className="relative h-full rounded-lg bg-card p-4 transform group-hover:translate-y-[-4px] group- transition-all duration-500 flex flex-col items-center justify-center">
