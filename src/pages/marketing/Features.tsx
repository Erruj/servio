...
export default function Features() {
  ...
  const items = t("marketing.featuresPage.items", {
    returnObjects: true,
  }) as Array<{
    id: string;
    title: string;
  ...
  const security = t("marketing.featuresPage.security", {
    returnObjects: true,
  }) as { title: string; description: string; points: string[] };
              ...
              <div className="max-w-3xl mx-auto text-center">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold tracking-[-0.02em] text-foreground mb-6 leading-tight">
                  ...
                  <span className="text-primary">
                    {t("marketing.featuresPage.h1Bottom")}
                  </span>
                </h1>
