...
const COMPARISON: {
  ...
  {
    feature: "Geavanceerde rapportages",
    free: false,
    starter: false,
    pro: true,
    business: true,
...
function renderCell(v: Cell) {
  if (v === true)
    return <Check className="w-5 h-5 text-success mx-auto" aria-label="Ja" />;
  if (v === false)
    return (
      <X className="w-5 h-5 text-muted-foreground mx-auto" aria-label="Nee" />
    );
...
export default function MarketingPricing() {
  ...
  const visibleFeatures = showAllFeatures
    ? COMPARISON
    : COMPARISON.filter((c) => c.key);

  const faqItems =
    (t("marketing.faq.items", { returnObjects: true }) as Array<{
      q: string;
      a: string;
    }>) || [];
        ...
        <main>
              ...
              <div className="max-w-3xl mx-auto text-center">
                ...
                <p className="text-lg md:text-xl text-muted-foreground max-w-xl mx-auto leading-relaxed mb-8">
                  ...
                  {billing === "monthly"
                    ...
                    : "Inclusief 14 dagen gratis proberen"}
                    ...
                    >
                      ...
                      <div className="mb-6 min-h-[88px]">
                        ...
                        {isYearly && (
                          ...
                          >
                            Gefactureerd als €
                            {plan.yearlyTotal.toFixed(2).replace(".", ",")}/jaar
                            · Bespaar €
                            {plan.yearlySavings.toFixed(2).replace(".", ",")}
                          </p>
                        )}
                        <p
                          className={cn(
          ...
          <section className="py-16 md:py-20">
            <div className="container mx-auto px-6">
              ...
              <div className="max-w-5xl mx-auto overflow-x-auto rounded-xl bg-card">
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-border/40">
                      <th className="text-left p-4 md:p-5 font-medium text-muted-foreground w-1/3">
                        Feature
                      </th>
                  ...
                  <tbody>
                    {visibleFeatures.map((row, i) => (
                      ...
                      >
                        <td className="p-4 md:p-5 text-foreground">
                          {row.feature}
                        </td>
              ...
              <div className="mt-4 max-w-2xl mx-auto">
                <div className="rounded-xl bg-muted/30 p-8 text-center">
                  ...
                  <p className="text-muted-foreground mb-4">
                    Voor grotere teams of specifieke wensen maken we graag een
                    offerte op maat.
                  </p>
                  <Button
                    variant="outline"
                    onClick={() =>
                      (window.location.href = "mailto:info@getservio.co")
                    }
                  >
                    Neem contact op
                  </Button>
