...
export default function MarketingPricing() {
 ...
 billing === 'monthly' ? 'bg-background text-foreground ' : 'text-muted-foreground hover:text-foreground'
 )}
 ...
 className={cn(
 'relative z-10 px-5 py-2 rounded-full text-sm font-medium transition-colors duration-300',
 billing === 'yearly' ? 'bg-background text-foreground ' : 'text-muted-foreground hover:text-foreground'
 )}
