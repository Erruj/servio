        ...
        <main className="max-w-3xl mx-auto px-6 py-16 md:py-24">
          ...
          <div className="mt-16 p-8 rounded-xl bg-primary/5 border border-primary/20 text-center">
            ...
            <p className="text-muted-foreground mb-6">
              Probeer Servio 14 dagen gratis. Geen creditcard nodig.
            </p>
            <Button asChild size="lg">
              <Link to="/signup">Start gratis proefperiode</Link>
            </Button>
          </div>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                {related.map((r) => (
                  <Link
                    key={r.slug}
                    to={`/blog/${r.slug}`}
                    className="group block rounded-xl p-5 hover:border-primary/30 transition-all"
                  >
                    <h3 className="font-semibold mb-1 group-hover:text-primary transition-colors text-sm leading-snug">
                      {r.title}
                    </h3>
