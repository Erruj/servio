...
export default function About() {
  ...
  const stats = t("marketing.about.stats", { returnObjects: true }) as Array<{
    value: string;
    label: string;
  }>;
  const values = t("marketing.about.values", { returnObjects: true }) as Array<{
    title: string;
    description: string;
  }>;
                ...
                <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
                  ...
                  <p
                    dangerouslySetInnerHTML={{
                      __html: t("marketing.about.missionP2"),
                    }}
                  />
            ...
            <div className="container mx-auto px-6">
              <div className="max-w-xl mx-auto text-center mb-16">
                ...
                <p className="text-muted-foreground">
                  {t("marketing.about.valuesSubtitle")}
                </p>
              </div>
              ...
              <div className="grid sm:grid-cols-2 gap-6 max-w-4xl mx-auto">
                {values.map((value, index) => {
                  ...
                  return (
                    <article key={index} className="p-8 rounded-xl bg-card ">
